...
/**********************************************************************************************
 ...
 Once the database which uses large buffer memory is determined above, the following script can be run
 to determine which object within the database shares large spaces [in the buffer memory]
